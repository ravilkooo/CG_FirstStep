...
Gates::Gates(DirectX::XMFLOAT4 position, float width) : position(position), width(width)
{
	...
	DirectX::XMFLOAT4 _points[8] = {
		DirectX::XMFLOAT4(position.x + width, 1.f, position.z + 0.0f, position.w + 0.0f),	DirectX::XMFLOAT4(0.5f, 0.5f, 0.5f, 1.0f),
		DirectX::XMFLOAT4(position.x, -1.f, position.z + 0.0f, position.w + 0.0f),	DirectX::XMFLOAT4(0.5f, 0.5f, 0.5f, 1.0f),
		DirectX::XMFLOAT4(position.x + width, -1.f, position.z + 0.0f, position.w + 0.0f),	DirectX::XMFLOAT4(0.5f, 0.5f, 0.5f, 1.0f),
		DirectX::XMFLOAT4(position.x, 1.f, position.z + 0.0f, position.w + 0.0f),	DirectX::XMFLOAT4(0.5f, 0.5f, 0.5f, 1.0f),
	};
