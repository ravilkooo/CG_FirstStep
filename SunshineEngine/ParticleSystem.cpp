	...
	: m_d3dDevice(device), m_d3dContext(context)
{
	...
	*/
	...
	D3DCompileFromFile(L"./Shaders/Particles/ResetCShader.hlsl",
		nullptr,
	...
	D3DCompileFromFile(L"./Shaders/Particles/InitSimulateDispatchArgsCShader.hlsl",
		nullptr,
		D3D_COMPILE_STANDARD_FILE_INCLUDE,
		"main", "cs_5_0",
		D3DCOMPILE_DEBUG | D3DCOMPILE_SKIP_OPTIMIZATION, 0,
	...
	D3DCompileFromFile(L"./Shaders/Particles/EmitParticlesCShader.hlsl",
		nullptr,
		D3D_COMPILE_STANDARD_FILE_INCLUDE,
		"main", "cs_5_0",
		D3DCOMPILE_DEBUG | D3DCOMPILE_SKIP_OPTIMIZATION, 0,
	...
	D3DCompileFromFile(L"./Shaders/Particles/SimulateParticlesCShader.hlsl",
		nullptr,
		D3D_COMPILE_STANDARD_FILE_INCLUDE,
		"main", "cs_5_0",
		D3DCOMPILE_DEBUG | D3DCOMPILE_SKIP_OPTIMIZATION, 0,
...

	{
		...
		D3DCompileFromFile(L"./Shaders/Particles/RenderParticles_VS.hlsl",
		...
		HRESULT hr =
			D3DCompileFromFile(L"./Shaders/Particles/RenderParticles_GS.hlsl",
				nullptr, D3D_COMPILE_STANDARD_FILE_INCLUDE,
				"main", "gs_5_0",
				D3DCOMPILE_DEBUG | D3DCOMPILE_SKIP_OPTIMIZATION, 0,
		...
		D3DCompileFromFile(L"./Shaders/Particles/RenderParticles_PS.hlsl",
			nullptr, D3D_COMPILE_STANDARD_FILE_INCLUDE,
			"main", "ps_5_0",
			D3DCOMPILE_DEBUG | D3DCOMPILE_SKIP_OPTIMIZATION, 0,
			&ps_blob, nullptr);
