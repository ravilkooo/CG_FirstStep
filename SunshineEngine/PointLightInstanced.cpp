    ...
    : lightsCnt(lightsCnt)
{
    ...
    */
    ...
    // LightPass
    {
        ...
        Bind::VertexShader* vertexShaderB = new Bind::VertexShader(device, L"./Shaders/LightPass/PointLightInstancedVShader.hlsl");
        ...
        lightPass->AddBind(new Bind::PixelShader(device, L"./Shaders/LightPass/PointLightInstancedPShader.hlsl"));
